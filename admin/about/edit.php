...
$res_about = mysqli_query($mysqli, "SELECT * FROM tb_about WHERE 
id_about=$id_about");
...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_about SET
     gambar='$file_name', 
     nama='$nama',
     nim='$nim',
     job='$job'
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../admin/about/edit.php?page=about" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $row_nim ?>" name="nim" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="job">job</label>
                                            <input type="text" class="form-control" value="<?= $row_job ?>" name="job" required>
                                        </div>
                                        <div class="form-group">
